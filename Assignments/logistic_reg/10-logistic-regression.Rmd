...
+ This model performs well when considering the split, the resulting AUC of both the training split (~85%) and the testing split (~83%) are high but not clearly over-fitted as these values are not vastly different.
