...
2. Compare models 2 and 3. What are the AUC values for each? Does including `skin` in the model seem to improve the model's performance?
  ...
  + Model 3 **(AUC = 0.8198)** has a higher AUC value than Model 2 **(AUC = 0.8186)** making it the better of the two. The inclusion of *skin* was not a favorable addition to this model as it did not increase the AUC by a signifiant amount (~ 0.00).
...
```{r}
threshold <- 0.8
model1 <- glm(diabetic ~. data = pima, family = "binomal")
